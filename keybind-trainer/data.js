...
const KEYBINDS = [
  ...
  { id: "jump_source_nav", category: "Master Your IDE", action: "Jump to source / navigation bar", keybind: "F4 / Alt+Home" },
  ...
  { id: "next_prev_tab", category: "Master Your IDE", action: "Go to next / previous editor tab", keybind: "Alt+Right / Alt+Left" },
  ...
  { id: "find_replace", category: "Find Everything", action: "Find / replace", keybind: "Ctrl+F / Ctrl+R" },
  { id: "find_replace_path", category: "Find Everything", action: "Find in path / Replace in path", keybind: "Ctrl+Shift+F / Ctrl+Shift+R" },
  ...
  { id: "go_class_file", category: "Find Everything", action: "Go to class / file", keybind: "Ctrl+N / Ctrl+Shift+N" },
  ...
  { id: "copy_move", category: "Refactor and Clean Up", action: "Copy… / Move…", keybind: "F5 / F6" },
  ...
  { id: "param_context", category: "Create and Edit", action: "Parameter info / context info", keybind: "Ctrl+P / Alt+Q" },
  ...
  { id: "extend_shrink", category: "Create and Edit", action: "Extend / shrink selection", keybind: "Ctrl+W / Ctrl+Shift+W" },
  ...
  { id: "join_split_line", category: "Create and Edit", action: "Join / split line", keybind: "Ctrl+Shift+J / Ctrl+Enter" },
  ...
  { id: "recent_viewed_locations", category: "Navigate In Context", action: "Recently viewed / recent locations", keybind: "Ctrl+E / Ctrl+Shift+E" },
